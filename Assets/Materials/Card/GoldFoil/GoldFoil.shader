	...
	SubShader
	{
		...
		CGPROGRAM
			...
			fixed4 frag(v2f IN  ) : SV_Target
			{
				...
				float4 color146 = IsGammaSpace() ? float4(0.9433962,0.731577,0.4138483,1) : float4(0.8760344,0.4942802,0.1427814,1);
				float border21_g10 = _IsFrame;
				float4 lerpResult19_g10 = lerp( color18_g10 , color146 , border21_g10);
				float2 uv_MainTex = IN.texcoord.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				float4 temp_output_126_0 = ( lerpResult19_g10 * tex2D( _MainTex, uv_MainTex ) );
				float4 color139 = IsGammaSpace() ? float4(0.3301887,0.2275357,0.1043521,1) : float4(0.08908623,0.04234187,0.01071156,1);
				...
				float4 lerpResult143 = lerp( temp_output_126_0 , ( temp_output_126_0 * ( 2.0 * ( color139 + ( ( 1.0 - saturate( abs( dotResult118 ) ) ) / 2.0 ) ) ) ) , border21_g10);
...
/*ASEBEGIN
Version=18900
-1960;71;1904;934;-1860.048;1292.692;1.353008;True;False
...
Node;AmplifyShaderEditor.ColorNode;139;3194.024,-658.7869;Inherit;False;Constant;_Color1;Color 1;28;0;Create;True;0;0;0;False;0;False;0.3301887,0.2275357,0.1043521,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleDivideOpNode;125;3323.978,-426.7427;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;146;3108.224,-1056.45;Inherit;False;Constant;_Color2;Color 2;28;0;Create;True;0;0;0;False;0;False;0.9433962,0.731577,0.4138483,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;151;3487.25,-776.8273;Inherit;False;Constant;_Float9;Float 9;28;0;Create;True;0;0;0;False;0;False;2;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;1366.634,3281.189;Float;False;Property;_CoatAmount;Coat Amount;32;0;Create;True;0;0;0;False;0;False;0;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;107;2490.82,926.5985;Inherit;False;MF_FrontWeitgth;-1;;8;99a400e47f3aca240af2ff536cf9cc05;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;77;1437.143,1897.979;Float;False;Property;_FlakesBump;Flakes Bump;29;0;Create;True;0;0;0;False;0;False;0;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;74;2990.502,2836.802;Float;False;Property;_CoatBump;Coat Bump;31;0;Create;True;0;0;0;False;0;False;0;0.1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;90;3328.521,3086.514;Float;False;Property;_CoatSmoothness;Coat Smoothness;33;0;Create;True;0;0;0;False;0;False;0;0.95;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;89;3344.976,2781.401;Inherit;True;Property;_CoatNormal;Coat Normal;30;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;1;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;0.5;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=5C3E6A3D43A92FDFC3222ECDF9B5AA9F3933F444